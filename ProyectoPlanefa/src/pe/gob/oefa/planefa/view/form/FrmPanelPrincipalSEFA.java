...
public class FrmPanelPrincipalSEFA extends javax.swing.JFrame {
    ...
    public FrmPanelPrincipalSEFA() {
        ...
        this.lblNombreEfa.setText("Administrador");
    ...
    public void cargarDataInicial(){
        ...
        for (String anio : aniosPlanefa) {
            ...
            for (Document rowDocumentEfa : this.documentsEfa) {
                String rucEfa = rowDocumentEfa.get("ruc").toString();
                String nombreEfa = rowDocumentEfa.get("nombre").toString();
                String ambito = ((Document)rowDocumentEfa.get("ambito")).get("nombre", String.class);
                String oficinaDesconcentrada = ((Document)rowDocumentEfa.get("oficinaDesconcentrada")).get("nombre", String.class);
                Efa efa = new Efa();
                efa.setRuc(rucEfa);
                efa.setNombre(nombreEfa);
                efa.setAmbito(new Ambito("00", ambito));
                efa.setOficinaDesconcentrada(new OficinaDesconcentrada("00",oficinaDesconcentrada));
                
                Document document=null;
                for (Document rowDocumentPlanefa : this.documentsPlanefa) {
                    String docRuc = ((Document)rowDocumentPlanefa.get("efa")).get("ruc", String.class);                            
                    String docAnio = String.valueOf(((Document)rowDocumentPlanefa.get("periodo")).get("anio", Integer.class));                            
                    if(docRuc.equalsIgnoreCase(rucEfa) 
                            && docAnio.equalsIgnoreCase(anio)){
                        document = rowDocumentPlanefa;                    
                        break;
                    }
                }
