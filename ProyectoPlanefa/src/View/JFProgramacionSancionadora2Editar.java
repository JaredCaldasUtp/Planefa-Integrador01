 ...
 * @author Daniel
 */
public class JFProgramacionSancionadora2Editar extends javax.swing.JFrame {

    /**
     * Creates new form JFDatosGenerales
     */
    public JFProgramacionSancionadora2Editar() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Programación del ejercicio de la potestad sancionadora >> Editar");

        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Emisión de resoluciones finales de primera instancia de procedimientos iniciados el año" }));
        ...
        jComboBox3.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Expediente concluido" }));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFProgramacionSancionadora2Editar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JFProgramacionSancionadora2Editar().setVisible(true);
            }
        });
    }
